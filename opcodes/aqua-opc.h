...
typedef enum cgen_insn_type {
 ...
 , AQUA_INSN_STORE, AQUA_INSN_JL, AQUA_INSN_JR, AQUA_INSN_BEQ
 , AQUA_INSN_BNE, AQUA_INSN_BLT, AQUA_INSN_BLE, AQUA_INSN_BGT
 , AQUA_INSN_BGE, AQUA_INSN_SYSCALL, AQUA_INSN_SYSRET, AQUA_INSN_SYSR
 , AQUA_INSN_SYSW, AQUA_INSN_SYNC, AQUA_INSN_SYNC_V, AQUA_INSN_SYNC_I
 , AQUA_INSN_NOP
} CGEN_INSN_TYPE;
